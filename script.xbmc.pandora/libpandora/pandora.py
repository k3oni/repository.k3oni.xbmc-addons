...
class Pandora:
	...
	#	u.close()
        ...
        def addFeedback( self, stationId=None, song=None, rating=None ):
                ...
                args = ( self._timestamp(), self.authToken, stationId, song[1]["trackToken"], rating )
	...
	def addTiredSong( self, musicId ):
        ...
        def createStation( self, musicId=None ):
                ...
                args = ( self._timestamp(), self.authToken, "mi"+musicId, "" )
        ...
        def deleteStation( self, stationId=None ):
                ...
                args = ( self._timestamp(), self.authToken, stationId )
